      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            custom_row_info(text1: "Total", text2: r"$50.98"),
            const SizedBox(
              height: 20,
            ),
            const custom_creditcard_details(),
            const SizedBox(
              height: 75,
            ),
            const row_qrcode(),
...
class row_qrcode extends StatelessWidget {
  const row_qrcode({super.key});
...
class custom_creditcard_details extends StatelessWidget {
  const custom_creditcard_details({super.key});
...
class custom_details_date extends StatelessWidget {
  const custom_details_date({super.key});
